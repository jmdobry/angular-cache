/* global TestCacheFactory, TestCacheFactoryProvider, CACHE_DEFAULTS */
describe('CacheFactoryProvider.setCacheDefaults(options)', function () {
  it('should have the correct defaults.', function () {
    ...
    assert.equal(cache.info().enabled, CACHE_DEFAULTS.enabled)
  })
  it('should set the default options.', function () {
    ...
    assert.equal(cache.info().enabled, options.enabled)
  })
})
