...
describe('Cache#removeAll()', function () {
  ...
  it('should remove items from localStorage when storageMode is used.', function () {
    var localStorageCache = TestCacheFactory.createCache('DSCache.removeAll.localStorageCache', {
      storageMode: 'localStorage',
      storageImpl: localStorage
    })
    var sessionStorageCache = TestCacheFactory.createCache('DSCache.removeAll.sessionStorageCache', {
